...
class Controller:
    ...
    def save_file(self, directory_name, read_or_write):
        try:
            if read_or_write == 'read':
                with open('default.txt', 'r') as text_file:
    ...
    def verify_variables(
            ...
            self.PROGRAM_DIR = os.getcwd()   # get the directory of the program
    ...
    def find_app_icon(self):
        ...
        # Check if 'squashfs-root' folder is found in home directory instead
        #  of the current location of app. So search there if icon list is empty.
